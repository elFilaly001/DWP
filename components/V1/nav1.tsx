        ...
        <nav className="hidden md:flex items-center gap-12">
          {navLinks.map((link, index) => (
            ...
            >
              ...
              {hoveredIndex === index && (
                <span
                  className="absolute -left-6 top-[6px] -translate-y-1/2 text-[#cbe425] text-sm font-medium animate-pulse select-none"
                  style={{
                    animation:
                  ...
                  aria-hidden="true"
                >
                   <img src="/LOGO/21212.png" alt="logo" className="h-6 w-auto" />
                </span>
              )}
            </Link>
          ))}

...
const defaultReferences: Reference[] = [
  { name: "Client 1", logo: "/LOGO/pharma5.webp" },
  { name: "Client 2", logo: "/LOGO/2.webp" },
  { name: "Client 3", logo: "/LOGO/maupassant.webp" },
  // { name: "Client 4", logo: "/LOGO/oncorad.png" },
  { name: "Client 5", logo: "/LOGO/sportetudes.webp" },
  { name: "Client 6", logo: "/LOGO/masenn.png" },
  { name: "Client 7", logo: "/LOGO/landor.webp" },
  { name: "Client 8", logo: "/LOGO/ocp.webp" },
  { name: "Client 9", logo: "/LOGO/pwc.webp" },
  { name: "Client 12", logo: "/LOGO/abs.webp" },
  { name: "Client 13", logo: "/LOGO/13.png" },
  { name: "Client 14", logo: "/LOGO/ofppt.webp" },
  { name: "Client 15", logo: "/LOGO/somfy.webp" },
  { name: "Client 16", logo: "/LOGO/total.webp" },
  { name: "Client 17", logo: "/LOGO/17.png" },
  { name: "Client 18", logo: "/LOGO/youcode.webp" },
  { name: "Client 19", logo: "/LOGO/cmc.webp" },
  { name: "Client 20", logo: "/LOGO/conceptcerame.webp" },
  { name: "Client 21", logo: "/LOGO/global.png" },
  { name: "Client 22", logo: "/LOGO/uir.webp" },
  { name: "Client 23", logo: "/LOGO/focusm.png" },
  { name: "Client 24", logo: "/LOGO/ldm6.webp" },
  // { name: "Client 24", logo: "/LOGO/lyceexcel.png" },
  { name: "Client 25", logo: "/LOGO/aefe.png" },
  { name: "Client 26", logo: "/LOGO/lyceefrancais.webp" },
  { name: "Client 27", logo: "/LOGO/daudet.webp" },
  { name: "Client 28", logo: "/LOGO/28.png" },
  { name: "Client 29", logo: "/LOGO/distribution.png" },
